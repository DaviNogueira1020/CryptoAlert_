    ...
    constructor() {
        this.register = async (req, res, next) => {
            try {
                ...
                return (0, response_1.sendSuccess)(res, result, 'Usuário registrado com sucesso', 201);
            }
            catch (error) {
        ...
        this.me = async (req, res, next) => {
            try {
                ...
                return (0, response_1.sendSuccess)(res, result, 'Usuário obtido');
            }
            catch (error) {
                return (0, response_1.sendError)(res, error.message, 400);
            }
        ...
        this.logout = async (req, res, next) => {
            try {
                ...
                return (0, response_1.sendSuccess)(res, result, 'Logout realizado com sucesso');
            }
            catch (error) {
                return (0, response_1.sendError)(res, error.message, 400);
            }
