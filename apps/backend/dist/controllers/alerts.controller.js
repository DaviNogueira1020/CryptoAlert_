...
async function criar(req, res) {
    try {
        const { userId, crypto, baseCurrency, targetPrice, direction, 
        // opcionais
        isFavorite, isActive, notifyOnce, initialPrice, title, notes, cooldown, scheduledAt, isScheduled, searchKey, } = req.body;
