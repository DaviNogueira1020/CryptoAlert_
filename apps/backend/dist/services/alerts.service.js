...
class AlertsService {
     ...
     */
    async criar(data) {
        const { userId, crypto, baseCurrency = "USDT", targetPrice, direction, 
        // novos campos
        isFavorite = false, isActive = true, notifyOnce = true, initialPrice = null, title = null, notes = null, cooldown = null, scheduledAt = null, isScheduled = false, searchKey, } = data;
        // validações básicas
