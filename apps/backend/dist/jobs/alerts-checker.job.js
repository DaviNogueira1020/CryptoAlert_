...
exports.iniciarJobAlertas = iniciarJobAlertas;
exports.pararJobAlertas = pararJobAlertas;
...
function iniciarJobAlertas(intervaloMs = 60000) {
    ...
    console.log(`[AlertsJob] Job iniciado. Verificando alertas a cada ${(intervaloMs / 1000)} segundos...`);
...
//# sourceMappingURL=alerts-checker.job.js.map