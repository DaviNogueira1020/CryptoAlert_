...
export function Login({ onLogin }: LoginProps) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // Generate a token using base64 encoding
      ...
      localStorage.setItem('cryptoAlerts', JSON.stringify([]));
        ...
        >
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <motion.button
              ...
              className="w-full bg-[#00B8D4]/20 text-[#00B8D4] py-3 rounded-lg hover:bg-[#00B8D4]/30 border border-[#00B8D4] transition-colors shadow-lg shadow-[#00B8D4]/20"
              whileHover={{ scale: 1.02 }}
              whileTap={{ scale: 0.98 }}
            >
              Demo Account
